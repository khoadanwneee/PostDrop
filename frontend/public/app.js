...
const stickerList = [
  ...
  },
  {
    id: "cute_star_silver",
    cat: "cute",
    title: "Ngôi sao bạc 3D",
    src: "/stickers/cute/cute_star_silver.png"
  },
  {
    id: "cute_cloud_blue",
    cat: "cute",
    title: "Đám mây mỉm cười",
  ...
  },
  {
    ...
    cat: "cute",
    title: "Luv u",
    src: "/stickers/cute/cute_luv_u.png"
  },
  {
    id: "cute_smiley_yellow",
    cat: "cute",
    title: "Mặt cười vàng",
    src: "/stickers/cute/cute_smiley_yellow.png"
  },
  {
    id: "cute_bestie",
    cat: "cute",
    title: "Bestie",
    src: "/stickers/cute/cute_bestie.png"
  },
  {
    id: "cute_star_blue",
    cat: "cute",
    title: "Ngôi sao xanh",
    src: "/stickers/cute/cute_star_blue.png"
  },
  {
    id: "cute_flower_pink",
    cat: "cute",
    title: "Hoa hồng nhỏ",
    src: "/stickers/cute/cute_flower_pink.png"
  },
  {
    id: "cute_nhan_cau_ne",
    cat: "cute",
    title: "Nhắn cậu nè",
    src: "/stickers/cute/cute_nhan_cau_ne.png"
  },
  {
    id: "cute_music_note",
    cat: "cute",
    title: "Nốt nhạc mơ mộng",
    src: "/stickers/cute/cute_music_note.png"
  },
  {
    id: "cute_you_got_this",
    cat: "cute",
    title: "You got this",
    src: "/stickers/cute/cute_you_got_this.png"
  },
  {
    id: "cute_chill_di",
    cat: "cute",
    title: "Chill đi",
    src: "/stickers/cute/cute_chill_di.png"
  },
  {
    id: "cute_crescent_moon",
    cat: "cute",
    title: "Trăng khuyết ngủ ngoan",
    src: "/stickers/cute/cute_crescent_moon.png"
  },
  {
    id: "cute_butterfly_purple",
    cat: "cute",
    title: "Bướm tím",
    src: "/stickers/cute/cute_butterfly_purple.png"
  },
  {
    id: "cute_tape_pink",
    cat: "cute",
    title: "Washi tape tim hồng",
    src: "/stickers/cute/cute_tape_pink.png"
  },
  {
    id: "cute_tape_checkered",
    cat: "cute",
    title: "Washi tape caro",
    src: "/stickers/cute/cute_tape_checkered.png"
  },
  {
    id: "cute_tape_daisy",
    cat: "cute",
    title: "Washi tape hoa cúc",
  ...
  },
  {
    ...
    cat: "cute",
    title: "Kẹo ngọt",
    src: "/stickers/cute/cute_keo_ngot.png"
  },
  {
    id: "cute_coffee_cup",
    cat: "cute",
    title: "Ly cà phê tim",
    src: "/stickers/cute/cute_coffee_cup.png"
  },
  {
    id: "cute_envelope_love",
    cat: "cute",
    title: "Phong bì tình yêu",
    src: "/stickers/cute/cute_envelope_love.png"
  },
  {
    id: "cute_laptop_pink",
    cat: "cute",
    title: "Laptop tim hồng",
    src: "/stickers/cute/cute_laptop_pink.png"
  },
  {
    id: "cute_camera_pink",
    cat: "cute",
    title: "Máy ảnh Y2K",
    src: "/stickers/cute/cute_camera_pink.png"
  },
  {
    id: "cute_xinh_iu",
    cat: "cute",
    title: "Xinh iu",
    src: "/stickers/cute/cute_xinh_iu.png"
  },
  {
    id: "cute_heart_silver",
    cat: "cute",
    title: "Trái tim bạc",
    src: "/stickers/cute/cute_heart_silver.png"
  },
  {
    id: "cute_sparkles_pink",
    cat: "cute",
  ...
  },
  {
    ...
    cat: "cute",
    title: "Nơ ngọc bích",
    src: "/stickers/cute/cute_bow_blue.png"
  },
  {
    id: "cute_chat_bubble",
    cat: "cute",
    title: "Khung tin nhắn tím",
    src: "/stickers/cute/cute_chat_bubble.png"
  },
  {
    id: "cute_star_face",
    cat: "cute",
    title: "Ngôi sao mỉm cười",
    src: "/stickers/cute/cute_star_face.png"
  },
  {
    id: "cute_heart_holographic",
    cat: "cute",
    title: "Trái tim cầu vồng",
    src: "/stickers/cute/cute_heart_holographic.png"
  },
  ...
  // 27 Y2K Stickers
  {
    id: "y2k_slay",
    cat: "y2k",
    title: "Chrome Slay 3D",
    src: "/stickers/y2k/y2k_slay.png"
  },
  {
    id: "y2k_phone_flip",
    cat: "y2k",
    title: "Điện thoại nắp gập ur so hot",
    src: "/stickers/y2k/y2k_phone_flip.png"
  },
  {
    id: "y2k_star_blue_3d",
    cat: "y2k",
    title: "Ngôi sao xanh 3D",
  ...
  },
  {
    ...
    cat: "y2k",
    title: "So iconic",
    src: "/stickers/y2k/y2k_so_iconic.png"
  },
  {
    id: "y2k_heart_checkered",
    cat: "y2k",
    title: "Trái tim caro",
    src: "/stickers/y2k/y2k_heart_checkered.png"
  },
  {
    id: "y2k_star_pink",
    cat: "y2k",
    title: "Ngôi sao hồng",
    src: "/stickers/y2k/y2k_star_pink.png"
  },
  {
    id: "y2k_heart_holographic",
    cat: "y2k",
    title: "Trái tim Holographic 3D",
    src: "/stickers/y2k/y2k_heart_holographic.png"
  },
  {
    id: "y2k_headphones",
    cat: "y2k",
    title: "Tai nghe chụp tai Y2K",
    src: "/stickers/y2k/y2k_headphones.png"
  },
  {
    id: "y2k_flame_blue",
    cat: "y2k",
  ...
  {
    id: "y2k_main_character",
    cat: "y2k",
    title: "Main character",
    src: "/stickers/y2k/y2k_main_character.png"
  },
  {
    id: "y2k_smiley_pink",
    cat: "y2k",
  ...
  {
    id: "y2k_camera_digital",
    cat: "y2k",
    title: "Máy ảnh kỹ thuật số Y2K",
    src: "/stickers/y2k/y2k_camera_digital.png"
  },
  {
    id: "y2k_xinh_iu",
    cat: "y2k",
    title: "Xinh iu Y2K",
    src: "/stickers/y2k/y2k_xinh_iu.png"
  },
  {
    id: "y2k_star_checkered",
    cat: "y2k",
    title: "Ngôi sao caro",
    src: "/stickers/y2k/y2k_star_checkered.png"
  },
  {
    id: "y2k_chill_di",
    cat: "y2k",
    title: "Chill đi blue speech",
    src: "/stickers/y2k/y2k_chill_di.png"
  },
  {
    id: "y2k_flame_smiley",
    cat: "y2k",
    title: "Ngọn lửa mặt cười hồng",
    src: "/stickers/y2k/y2k_flame_smiley.png"
  },
  {
    id: "y2k_ball_8",
    cat: "y2k",
    title: "Bóng bida số 8",
    src: "/stickers/y2k/y2k_ball_8.png"
  },
  {
    id: "y2k_loading",
    cat: "y2k",
    title: "Loading pixel tim",
    src: "/stickers/y2k/y2k_loading.png"
  },
  {
    id: "y2k_cursor",
    cat: "y2k",
    title: "Con trỏ chuột pixel",
    src: "/stickers/y2k/y2k_cursor.png"
  },
  {
    id: "y2k_butterfly_cyber",
    cat: "y2k",
    title: "Bướm Cyberpunk 3D",
    src: "/stickers/y2k/y2k_butterfly_cyber.png"
  },
  {
    id: "y2k_gamepad",
    cat: "y2k",
    title: "Tay cầm game PS2",
    src: "/stickers/y2k/y2k_gamepad.png"
  },
  {
    id: "y2k_badge_text",
    cat: "y2k",
    title: "Logo Y2K Chrome",
    src: "/stickers/y2k/y2k_badge_text.png"
  },
  {
    id: "y2k_lips_pink",
    cat: "y2k",
    title: "Đôi môi hồng sexy",
    src: "/stickers/y2k/y2k_lips_pink.png"
  },
  {
    id: "y2k_heart_blue_flame",
    cat: "y2k",
    title: "Trái tim ngọn lửa xanh",
    src: "/stickers/y2k/y2k_heart_blue_flame.png"
  },
  {
    id: "y2k_okurrr",
    cat: "y2k",
    title: "Okurrr",
    src: "/stickers/y2k/y2k_okurrr.png"
  },
  {
    id: "y2k_smiley_holographic",
    cat: "y2k",
    title: "Mặt cười Holographic",
    src: "/stickers/y2k/y2k_smiley_holographic.png"
  },
  {
    id: "y2k_sneaker_platform",
    cat: "y2k",
    title: "Giày sneaker Y2K lửa hồng",
    src: "/stickers/y2k/y2k_sneaker_platform.png"
  },

  // 40 Study Stickers
  {
    id: "study_you_got_this",
    cat: "study",
    title: "You got this cloud",
    src: "/stickers/study/study_you_got_this.png"
  },
  {
    id: "study_olive_star",
    cat: "study",
    title: "Ngôi sao xanh olive",
    src: "/stickers/study/study_olive_star.png"
  },
  {
    id: "study_star_face",
    cat: "study",
    title: "Ngôi sao mỉm cười",
    src: "/stickers/study/study_star_face.png"
  },
  {
    id: "study_study_mode",
    cat: "study",
    title: "Study mode badge",
    src: "/stickers/study/study_study_mode.png"
  },
  {
    id: "study_coffee_first",
    cat: "study",
    title: "Cốc cà phê Coffee First",
    src: "/stickers/study/study_coffee_first.png"
  },
  {
    id: "study_matcha_love",
    cat: "study",
    title: "Ly Matcha Latte",
    src: "/stickers/study/study_matcha_love.png"
  },
  {
    id: "study_tote_bag",
    cat: "study",
    title: "Túi vải Tote Bookish Things",
    src: "/stickers/study/study_tote_bag.png"
  },
  {
    id: "study_heart_pink",
    cat: "study",
    title: "Trái tim hồng mỉm cười",
    src: "/stickers/study/study_heart_pink.png"
  },
  {
    id: "study_nhan_cau_ne",
    cat: "study",
    title: "Nhắn cậu nè speech bubble",
    src: "/stickers/study/study_nhan_cau_ne.png"
  },
  {
    id: "study_leaf_branch",
    cat: "study",
    title: "Cành lá olive",
    src: "/stickers/study/study_leaf_branch.png"
  },
  {
    id: "study_notebook_bear",
    cat: "study",
    title: "Sổ gáy xoắn gấu nhỏ",
    src: "/stickers/study/study_notebook_bear.png"
  },
  {
    id: "study_pencil",
    cat: "study",
  ...
  },
  {
    ...
    cat: "study",
    title: "Focus badge",
    src: "/stickers/study/study_focus.png"
  },
  {
    id: "study_heart_blue",
    cat: "study",
    title: "Trái tim xanh pastel",
    src: "/stickers/study/study_heart_blue.png"
  },
  {
    id: "study_smiley_yellow",
    cat: "study",
    title: "Mặt cười vàng nhỏ",
    src: "/stickers/study/study_smiley_yellow.png"
  },
  {
    id: "study_book_stack",
    cat: "study",
    title: "Chồng sách cổ điển & kính cận",
    src: "/stickers/study/study_book_stack.png"
  },
  {
    id: "study_cat_sleeping",
    cat: "study",
    title: "Mèo con nằm ngủ",
    src: "/stickers/study/study_cat_sleeping.png"
  },
  {
    id: "study_binder_clip",
    cat: "study",
    title: "Kẹp giấy binder clip",
    src: "/stickers/study/study_binder_clip.png"
  },
  {
    id: "study_paper_plane",
    cat: "study",
    title: "Máy bay giấy bay",
    src: "/stickers/study/study_paper_plane.png"
  },
  {
    id: "study_laptop_cozy",
    cat: "study",
    title: "Laptop nắp gập cozy",
    src: "/stickers/study/study_laptop_cozy.png"
  },
  {
    id: "study_headphones_beige",
    cat: "study",
    title: "Tai nghe chụp tay kem beige",
    src: "/stickers/study/study_headphones_beige.png"
  },
  {
    id: "study_camera_instant",
    cat: "study",
    title: "Máy ảnh lấy liền & ảnh in",
    src: "/stickers/study/study_camera_instant.png"
  },
  {
    id: "study_polaroid_flowers",
    cat: "study",
    title: "Khung ảnh Polaroid hoa tulip",
    src: "/stickers/study/study_polaroid_flowers.png"
  },
  {
    id: "study_quote_note",
    cat: "study",
    title: "Giấy ghi chú câu nói động lực",
    src: "/stickers/study/study_quote_note.png"
  },
  {
    id: "study_good_day",
    cat: "study",
    title: "Good day badge",
    src: "/stickers/study/study_good_day.png"
  },
  {
    id: "study_to_do_list",
    cat: "study",
    title: "Bảng To-do list học tập",
    src: "/stickers/study/study_to_do_list.png"
  },
  {
    id: "study_flower_yellow",
    cat: "study",
    title: "Cành hoa vàng nhỏ",
    src: "/stickers/study/study_flower_yellow.png"
  },
  {
    id: "study_heart_plaid",
    cat: "study",
    title: "Trái tim kẻ caro",
    src: "/stickers/study/study_heart_plaid.png"
  },
  {
    id: "study_take_a_break",
    cat: "study",
    title: "Take a break speech bubble",
    src: "/stickers/study/study_take_a_break.png"
  },
  {
    id: "study_its_ok_to_rest",
    cat: "study",
    title: "It's ok to rest cloud",
    src: "/stickers/study/study_its_ok_to_rest.png"
  },
  {
    id: "study_bear_pouch",
    cat: "study",
    title: "Linh vật gấu trắng dễ thương",
    src: "/stickers/study/study_bear_pouch.png"
  },
  {
    id: "study_mug_coffee",
    cat: "study",
    title: "Cốc gốm sứ cà phê nóng",
    src: "/stickers/study/study_mug_coffee.png"
  },
  {
    id: "study_paperclips",
    cat: "study",
    title: "Bộ 3 kẹp ghim giấy pastel",
    src: "/stickers/study/study_paperclips.png"
  },
  {
    id: "study_plant_potted",
    cat: "study",
    title: "Chậu cây cảnh để bàn",
    src: "/stickers/study/study_plant_potted.png"
  },
  {
    id: "study_tape_grid",
    cat: "study",
    title: "Washi tape kẻ ô beige",
    src: "/stickers/study/study_tape_grid.png"
  },
  {
    id: "study_tape_daisy",
    cat: "study",
    title: "Washi tape hoa cúc olive",
    src: "/stickers/study/study_tape_daisy.png"
  },
  {
    id: "study_tape_polkadot",
    cat: "study",
    title: "Washi tape chấm bi xanh",
    src: "/stickers/study/study_tape_polkadot.png"
  },
  {
    id: "study_tape_gingham",
    cat: "study",
    title: "Washi tape caro vàng",
    src: "/stickers/study/study_tape_gingham.png"
  },
  {
    id: "study_tape_hearts",
    cat: "study",
    title: "Washi tape tim cam đất",
    src: "/stickers/study/study_tape_hearts.png"
  },
  {
    id: "study_tape_floral",
    cat: "study",
    title: "Washi tape hoạ tiết hoa nhỏ",
    src: "/stickers/study/study_tape_floral.png"
  },

  // 31 Scrapbook Stickers
  {
    id: "scrapbook_little_moments",
    cat: "scrapbook",
    title: "Little moments label",
    src: "/stickers/scrapbook/scrapbook_little_moments.png"
  },
  {
    id: "scrapbook_dried_wildflowers",
    cat: "scrapbook",
    title: "Hoa dại khô dán băng keo",
    src: "/stickers/scrapbook/scrapbook_dried_wildflowers.png"
  },
  {
    id: "scrapbook_stamp_mountain",
    cat: "scrapbook",
    title: "Tem bưu chính núi rừng 20¢",
    src: "/stickers/scrapbook/scrapbook_stamp_mountain.png"
  },
  {
    id: "scrapbook_pink_flower",
    cat: "scrapbook",
    title: "Hoa cúc hồng mộc mạc",
    src: "/stickers/scrapbook/scrapbook_pink_flower.png"
  },
  {
    id: "scrapbook_film_strip",
    cat: "scrapbook",
    title: "Cuộn phim ảnh Vintage 3 ô",
    src: "/stickers/scrapbook/scrapbook_film_strip.png"
  },
  {
    id: "scrapbook_mushroom",
    cat: "scrapbook",
    title: "Nấm rừng minh hoạ cổ điển",
    src: "/stickers/scrapbook/scrapbook_mushroom.png"
  },
  {
    id: "scrapbook_be_kind",
    cat: "scrapbook",
    title: "Trái tim Be kind xanh olive",
    src: "/stickers/scrapbook/scrapbook_be_kind.png"
  },
  {
    id: "scrapbook_torn_note_time",
    cat: "scrapbook",
    title: "Mảnh giấy xé it's okay to take your time",
    src: "/stickers/scrapbook/scrapbook_torn_note_time.png"
  },
  {
    id: "scrapbook_cloud_vintage",
    cat: "scrapbook",
    title: "Đám mây minh hoạ cổ điển",
    src: "/stickers/scrapbook/scrapbook_cloud_vintage.png"
  },
  {
    id: "scrapbook_dear_diary",
    cat: "scrapbook",
    title: "Nhãn Dear diary",
    src: "/stickers/scrapbook/scrapbook_dear_diary.png"
  },
  {
    id: "scrapbook_post_card",
    cat: "scrapbook",
    title: "Bưu thiếp xanh Wish you were here",
    src: "/stickers/scrapbook/scrapbook_post_card.png"
  },
  {
    id: "scrapbook_camera_vintage",
    cat: "scrapbook",
    title: "Máy ảnh cơ 35mm Vintage",
    src: "/stickers/scrapbook/scrapbook_camera_vintage.png"
  },
  {
    id: "scrapbook_sun_face",
    cat: "scrapbook",
    title: "Mặt trời thần thoại cổ đại",
    src: "/stickers/scrapbook/scrapbook_sun_face.png"
  },
  {
    id: "scrapbook_olive_leaves",
    cat: "scrapbook",
    title: "Cành lá xanh mộc mạc",
    src: "/stickers/scrapbook/scrapbook_olive_leaves.png"
  },
  {
    id: "scrapbook_ticket_pink",
    cat: "scrapbook",
    title: "Vé hồng Good things are coming",
    src: "/stickers/scrapbook/scrapbook_ticket_pink.png"
  },
  {
    id: "scrapbook_ticket_admit_one",
    cat: "scrapbook",
    title: "Vé xi nê Admit One",
    src: "/stickers/scrapbook/scrapbook_ticket_admit_one.png"
  },
  {
    id: "scrapbook_heart_pink_sketch",
    cat: "scrapbook",
    title: "Trái tim nét vẽ phác thảo",
    src: "/stickers/scrapbook/scrapbook_heart_pink_sketch.png"
  },
  {
    id: "scrapbook_see_u_soon",
    cat: "scrapbook",
    title: "Badge See u soon xanh olive",
    src: "/stickers/scrapbook/scrapbook_see_u_soon.png"
  },
  {
    id: "scrapbook_crescent_moon_face",
    cat: "scrapbook",
    title: "Trăng khuyết ngủ ngoan & ngôi sao",
    src: "/stickers/scrapbook/scrapbook_crescent_moon_face.png"
  },
  {
    id: "scrapbook_gingham_tape",
    cat: "scrapbook",
    title: "Băng keo washi kẻ ô nâu",
    src: "/stickers/scrapbook/scrapbook_gingham_tape.png"
  },
  {
    id: "scrapbook_soft_life",
    cat: "scrapbook",
    title: "Trái tim Soft life xanh xám",
    src: "/stickers/scrapbook/scrapbook_soft_life.png"
  },
  {
    id: "scrapbook_pink_wildflowers",
    cat: "scrapbook",
    title: "Cành hoa dại hồng dán băng keo",
    src: "/stickers/scrapbook/scrapbook_pink_wildflowers.png"
  },
  {
    id: "scrapbook_map_vintage",
    cat: "scrapbook",
    title: "Bản đồ cổ Let's get lost",
    src: "/stickers/scrapbook/scrapbook_map_vintage.png"
  },
  {
    id: "scrapbook_healing_note",
    cat: "scrapbook",
    title: "Mảnh giấy Healing chữa lành",
    src: "/stickers/scrapbook/scrapbook_healing_note.png"
  },
  {
    id: "scrapbook_today_checklist",
    cat: "scrapbook",
    title: "Checklist Today coffee & sunshine",
    src: "/stickers/scrapbook/scrapbook_today_checklist.png"
  },
  {
    id: "scrapbook_daisy_bouquet",
    cat: "scrapbook",
    title: "Bó hoa cúc hoang mộc mạc",
    src: "/stickers/scrapbook/scrapbook_daisy_bouquet.png"
  },
  {
    id: "scrapbook_take_care",
    cat: "scrapbook",
    title: "Badge Take care of yourself",
    src: "/stickers/scrapbook/scrapbook_take_care.png"
  },
  {
    id: "scrapbook_ticket_collect",
    cat: "scrapbook",
    title: "Vé Collect beautiful things",
    src: "/stickers/scrapbook/scrapbook_ticket_collect.png"
  },
  {
    id: "scrapbook_grow_through",
    cat: "scrapbook",
    title: "Tranh in botanical Grow through what you go through",
    src: "/stickers/scrapbook/scrapbook_grow_through.png"
  },
  {
    id: "scrapbook_world_be_kind",
    cat: "scrapbook",
    title: "Giấy note In a world where you can be anything, be kind",
    src: "/stickers/scrapbook/scrapbook_world_be_kind.png"
  },
  {
    id: "scrapbook_keep_going",
    cat: "scrapbook",
    title: "Huy hiệu phong cảnh Keep going",
    src: "/stickers/scrapbook/scrapbook_keep_going.png"
  }
];
...
function renderStickerLibrary() {
  ...
  const tabsHtml = stickerCategories
    .map((cat) => {
      const count =
        cat.id === "all"
          ? stickerList.length
          : stickerList.filter((s) => s.cat === cat.id).length;
...
const icons = {
  ...
  archive:
    '<rect x="3" y="4" width="18" height="5" rx="1"/><path d="M5 9v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V9M10 13h4"/>',
  ...
  pen: '<path d="m4 20 4.5-1 10-10a2.1 2.1 0 0 0-3-3l-10 10z"/><path d="m14 7 3 3M4 20l3-3"/>',
  plus: '<path d="M12 5v14M5 12h14"/>',
  seal: '<path d="M12 3a4 4 0 0 1 4 4c2.8 0 4.2 3.4 2.2 5.3 1.3 2.5-.9 5.2-3.6 4.4A4 4 0 0 1 8 17c-2.8.8-4.9-2-3.6-4.4C2.2 10.7 3.6 7.3 6.4 7A4 4 0 0 1 12 3z"/><path d="m9.5 12 1.7 1.7 3.5-4"/>',
  shield:
...
const icon = (name) =>
  icons[name]
    ? `<svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${icons[name]}</svg>`
    : "";
...
function pricingProduct(deliveryMethod = draft.deliveryMethod) {
  return deliveryMethod === "physical" ? "physical" : "digital";
}

function pricingText(product, prefix = "") {
  const quote = pricingCatalog?.[product];
  return quote
    ? `${prefix}${formatMoney(quote.amount, pricingCatalog.currency)}`
    : "Đang tải giá…";
}

function pricingMarkup(product, prefix = "") {
  return `<span data-pricing-product="${product}" data-pricing-prefix="${escapeHtml(prefix)}">${pricingText(product, prefix)}</span>`;
}
...
async function loadPricingCatalog() {
  try {
    ...
    document.querySelectorAll("[data-pricing-product]").forEach((element) => {
      element.textContent = pricingText(
        element.dataset.pricingProduct,
        element.dataset.pricingPrefix || ""
      );
    });
  } catch (error) {
    console.warn("Could not load pricing catalog:", error);
  }
}
...
const themeDecorationPresets = {
  ...
  scrapbook: [
    {
      type: "scrapbook_dried_wildflowers",
      x: 11,
      y: 11,
      width: 21,
      rotation: -9
...
let draft = {
  ...defaultDraft,
  ...storedDraft,
  decorations: Array.isArray(storedDraft.decorations)
    ? storedDraft.decorations
    : [],
  userElements: Array.isArray(storedDraft.userElements)
    ? storedDraft.userElements
    : [],
  draftId:
    typeof storedDraft.draftId === "string" && storedDraft.draftId
      ? storedDraft.draftId
      : createDraftId()
};
if (draft.deliveryMethod === "hybrid") draft.deliveryMethod = "email";
...
const legacyTheme =
  typeof storedDraft.theme === "string" ? storedDraft.theme : "none";
draft.selectedThemeId =
  typeof storedDraft.selectedThemeId === "string" &&
  storedDraft.selectedThemeId.endsWith(`-${draft.paperOrientation}`)
...
window.addEventListener("postdrop-editor-change", (event) => {
  ...
  if (typeof next.letterContent === "string")
    draft.content = next.letterContent;
  if (typeof next.letterTitle === "string") draft.title = next.letterTitle;
  if (
    next.letterFont === "serif" ||
    next.letterFont === "modern" ||
    next.letterFont === "hand"
  ) {
    draft.font = next.letterFont;
  }
  if (
    next.paperOrientation === "portrait" ||
    next.paperOrientation === "landscape"
  ) {
    draft.paperOrientation = next.paperOrientation;
  }
  if (
    typeof next.selectedThemeId === "string" ||
    next.selectedThemeId === null
  ) {
...
function openModal({
  ...
  modalRoot.innerHTML = `<div class="modal-backdrop" role="dialog" aria-modal="true" aria-labelledby="modal-title"><div class="modal confirmation-modal ${escapeHtml(modalClass)}">${iconName ? `<div class="confirmation-modal-icon" aria-hidden="true">${icon(iconName)}</div>` : ""}<div class="confirmation-modal-copy"><h2 id="modal-title">${escapeHtml(title)}</h2><p>${escapeHtml(message)}</p></div>${note ? `<div class="confirmation-modal-note">${icon("info")}<span>${escapeHtml(note)}</span></div>` : ""}<div class="modal-actions"><button type="button" class="button button-ghost" data-modal-close>${escapeHtml(cancel)}</button><button type="button" class="button button-primary" data-modal-confirm>${escapeHtml(confirm)}</button></div></div></div>`;
  const closeButton = modalRoot.querySelector("[data-modal-close]");
  if (closeButton)
    closeButton.onclick = () => {
      modalRoot.innerHTML = "";
    };
  modalRoot.querySelector("[data-modal-confirm]").onclick = () => {
    modalRoot.innerHTML = "";
    onConfirm?.();
  };
}
...
function openFormModal({
  ...
  modalRoot.innerHTML = `<div class="modal-backdrop" role="dialog" aria-modal="true" aria-labelledby="modal-title"><div class="modal ${escapeHtml(modalClass)}"><h2 id="modal-title">${escapeHtml(title)}</h2><div class="modal-body">${bodyHtml}</div><div class="modal-actions">${cancelText ? `<button type="button" class="button button-ghost" data-modal-close>${escapeHtml(cancelText)}</button>` : ""}<button type="button" class="button button-primary" data-modal-confirm>${escapeHtml(confirmText)}</button></div></div></div>`;
  const closeButton = modalRoot.querySelector("[data-modal-close]");
  if (closeButton)
    closeButton.onclick = () => {
      modalRoot.innerHTML = "";
...
async function openUserMenuModal() {
  const token = getAuthToken();
  const user = token ? await loadCurrentAuthUser() : null;
  const profile = userPresentation(user);
  openFormModal({
    title: "Tài khoản",
    bodyHtml: `
      <div class="profile-summary">
        <div class="avatar profile-avatar" aria-hidden="true">${escapeHtml(profile.initials)}</div>
        <div class="profile-identity">
          <strong>${escapeHtml(profile.name)}</strong>
          <span>${escapeHtml(profile.email)}</span>
        </div>
      </div>
      <div class="profile-status">${icon("seal")}<span>${token ? "Tài khoản đã được xác thực" : "Bạn chưa đăng nhập"}</span></div>
      <nav class="profile-links" aria-label="Lối tắt tài khoản">
        <a href="#/dashboard" data-profile-link>${icon("file")}<span><strong>Danh sách thư</strong><small>Xem và quản lý các lá thư của bạn</small></span>${icon("arrowRight")}</a>
        <a href="#/create/1?new=1" data-profile-link>${icon("pen")}<span><strong>Viết thư mới</strong><small>Bắt đầu một lá thư cho tương lai</small></span>${icon("arrowRight")}</a>
      </nav>
    `,
  ...
  modalRoot.querySelectorAll("[data-profile-link]").forEach((link) => {
...
function brand() {
  return `<a class="brand" href="#/" aria-label="PostDrop — Trang chủ"><span class="brand-mark"></span><span>PostDrop</span></a>`;
}
function button(label, route, kind = "primary", iconName = "") {
  return `<a class="button button-${kind}" href="#${route}">${label}${iconName ? icon(iconName) : ""}</a>`;
}

function siteHeader() {
  const accountLink = isLoggedIn()
    ? '<a class="text-button" href="#/dashboard">Tài khoản</a>'
    : '<a class="text-button" href="#/login">Đăng nhập</a>';
  return `<header class="site-header"><div class="container nav">${brand()}<nav class="nav-links" aria-label="Điều hướng chính"><a href="#/" data-scroll="how">Cách hoạt động</a><a href="#/" data-scroll="services">Mẫu thư</a><a href="#/" data-scroll="pricing">Bảng giá</a><a href="#/" data-scroll="trust">Dành cho tổ chức</a></nav><div class="nav-actions">${accountLink}${button("Viết thư ngay", "/create/1?new=1")}<button class="menu-toggle" aria-label="Mở menu">${icon("menu")}</button></div></div></header>`;
}

function appHeader() {
  const profile = userPresentation(currentAuthUser || authUserFromToken());
  queueMicrotask(() => {
    void hydrateAppHeaderProfile();
  });
  return `<header class="app-header"><div class="container app-header-inner">${brand()}<div class="app-header-actions"><a class="button button-primary" href="#/create/1?new=1">${icon("plus")}Tạo lá thư mới</a><button class="icon-button" aria-label="Thông báo" title="Thông báo">${icon("bell")}</button><a class="avatar" data-user-avatar href="#/dashboard" aria-label="Tài khoản ${escapeHtml(profile.name)}">${escapeHtml(profile.initials)}</a></div></div></header>`;
}

function journeyStep(iconName, title, text) {
  return `<div class="journey-step"><div class="step-icon">${icon(iconName)}</div><h3>${title}</h3><p>${text}</p></div>`;
}
function trustItem(iconName, title, text) {
  return `<article class="trust-item">${icon(iconName)}<h3>${title}</h3><p>${text}</p></article>`;
}
...
function renderLanding() {
  app.innerHTML = `<div class="page-shell">${siteHeader()}<main id="main-content">
    <section class="hero hero-invitation"><div class="invitation-frame" aria-hidden="true"><span class="frame-corner frame-corner-tl"></span><span class="frame-corner frame-corner-tr"></span><span class="frame-corner frame-corner-bl"></span><span class="frame-corner frame-corner-br"></span></div>${heroFlorals()}${landingPlane()}<div class="hero-content"><div class="invitation-monogram" aria-hidden="true"><span>P</span></div><span class="eyebrow">POSTDROP · THƯ GỬI ĐẾN TƯƠNG LAI</span><h1 class="hero-handwritten mea-culpa-regular"><span>Một lá thư từ chính bạn của những năm trước.</span></h1><div class="hero-floral-divider" aria-hidden="true"><span></span><i></i><span></span></div><p>Viết hôm nay, PostDrop sẽ lưu giữ và gửi lá thư đến đúng ngày bạn lựa chọn.</p><div class="hero-actions">${button("Viết thư cho tương lai", "/create/1?new=1", "primary", "arrowRight")}${hasMeaningfulDraft() ? button("Tiếp tục bản nháp", "/create/resume", "secondary", "arrowRight") : ""}</div></div></section>
    <section class="letter-section" id="how"><div class="container"><div class="section-head"><span class="chapter">CHƯƠNG 01</span><h2>Cách PostDrop hoạt động</h2><p>Một nghi thức nhỏ hôm nay, một cuộc gặp gỡ đặc biệt trong tương lai.</p></div><div class="journey"><div class="journey-planes" aria-hidden="true">${[25, 50, 75].map((pos) => `<span class="journey-plane" style="left:${pos}%">${paperPlane("journey-plane-icon")}</span>`).join("")}</div>${journeyStep("pen", "Viết thư", "Dành vài phút để viết điều bạn muốn nhớ.")}${journeyStep("seal", "Niêm phong", "Xác nhận nội dung và chọn ngày gặp lại.")}${journeyStep("archive", "Lưu giữ", "Chúng tôi bảo quản an toàn suốt hành trình.")}${journeyStep("truck", "Giao đúng hẹn", "Lá thư đến tay vào đúng ngày đã chọn.")}</div></div></section>
    <section class="letter-section" id="services"><div class="container"><div class="section-head"><span class="chapter">CHƯƠNG 02</span><h2>Viết thư trực tuyến</h2><p>Soạn lá thư trong không gian riêng tư, tùy chọn giấy, phong bì và lời nhắn video cho tương lai.</p></div><div class="service-grid" style="grid-template-columns:1fr;max-width:540px;margin:0 auto"><a href="#/create/1?new=1" class="service-card"><div class="service-art"><div class="paper-stack"></div></div><span class="eyebrow">TRỰC TUYẾN</span><h3>Viết thư trực tuyến</h3><p>Soạn thư trong không gian yên tĩnh, chọn giấy và phong bì, chúng tôi sẽ làm phần còn lại.</p><div class="service-meta"><span>5–10 phút</span>${pricingMarkup("digital", "Từ ")}</div></a></div></div></section>
    ...
    <section class="letter-section" id="pricing"><div class="container"><div class="section-head"><span class="chapter">CHƯƠNG 04</span><h2>Một mức giá cho mỗi cách gửi</h2><p>Thanh toán một lần. Không có phí ẩn trong suốt thời gian lưu giữ.</p></div><div class="pricing-grid">${priceCard("Email", "digital", ["Gửi qua email đúng hẹn", "Lưu giữ đến 5 năm", "Miễn phí giao qua email"])}${priceCard("Physical", "physical", ["In trên giấy cao cấp", "Phong bì và niêm phong", "Đã gồm phí giao hàng"], true)}</div></div></section>
    <section class="letter-section"><div class="container"><div class="quote-card"><blockquote class="mea-culpa-regular">“Tôi đã quên mình từng lo lắng nhiều đến thế. Lá thư ấy giống như một cái ôm đến muộn, nhưng đúng lúc.”</blockquote><cite>Hà My · Nhận thư sau 3 năm</cite></div></div></section>
...
function bindLanding() {
  ...
  document
    ...
    ?.addEventListener("click", () =>
      toast("Menu di động: dùng các mục ở cuối trang để khám phá.")
    );
...
function stepper(step) {
  return `<div class="stepper" aria-label="Tiến trình tạo thư">${steps.map((name, i) => `<div class="stepper-item ${i + 1 === step ? "active" : i + 1 < step ? "done" : ""}"><span class="stepper-dot">${i + 1 < step ? "✓" : i === 3 ? "3.5" : i < 3 ? i + 1 : i}</span><span>${name}</span></div>`).join("")}</div>`;
}
...
function renderBuilder(step = 1) {
  ...
  const stepEyebrow =
    step === 4
      ? "BƯỚC 3.5 / 5 — QUAY VIDEO CHO TƯƠNG LAI"
...
function stepTitle(step) {
  return [
    "Bạn muốn gửi lá thư theo cách nào?",
    "Bạn muốn viết thư với loại giấy nào?",
    "Viết điều bạn muốn gặp lại",
    "Gửi một lời nhắn cho chính mình trong tương lai",
    "Lá thư sẽ tìm đến ai?",
    "Kiểm tra trước khi niêm phong"
  ][step - 1];
}
function stepDescription(step) {
  return [
    "Chọn soạn trực tuyến hoặc để PostDrop đến nhận lá thư bạn đã tự tay viết.",
    "Bạn vẫn có thể đổi loại giấy sau trong trình chỉnh sửa.",
    "Viết trực tiếp trên trang thư rồi chọn theme và trang trí theo cách của bạn.",
    "Quay lại cảm xúc, suy nghĩ hoặc lời nhắn của bạn ở thời điểm hiện tại. Video này sẽ được lưu cùng bức thư và chỉ được mở vào thời điểm bạn đã chọn.",
    "Thông tin này giúp PostDrop giao lá thư đúng người, đúng ngày.",
    "Sau khi niêm phong, nội dung sẽ không thể chỉnh sửa."
  ][step - 1];
}

function renderSwatches(group, options) {
  return options
    .map(([value, colorClass, label]) =>
      swatch(group, value, colorClass, label)
    )
    .join("");
}

function renderThemePicker() {
  return `<div class="theme-picker">${themeOptions
    .map((theme) => {
...
function renderPaperOrientationStep() {
  return `<div class="paper-orientation-step">
    <div id="paper-orientation-root" data-draft-id="${escapeHtml(draft.draftId)}" aria-live="polite"></div>
  </div>${builderActions(2)}`;
}
...
function renderStep(step) {
  ...
  if (step === 1)
    return `<div class="panel step-one-panel"><div class="step-one-copy"><span class="eyebrow">HÌNH THỨC SOẠN THƯ</span><h2>Một không gian riêng cho điều bạn muốn giữ lại</h2><p>Chọn cách phù hợp với bạn. Dù là con chữ trên màn hình hay nét mực trên giấy, PostDrop đều lưu giữ cẩn thận.</p><div class="step-one-features"><span>${icon("pen")}Soạn trực tuyến</span><span>${icon("seal")}Niêm phong riêng tư</span><span>${icon("truck")}Nhận thư viết tay tận nơi</span></div></div><div class="choice-grid step-one-choice-grid">${typeCard("online", "pen", "Viết thư trực tuyến", "Soạn thư ngay trên PostDrop, chọn thiết kế và chúng tôi sẽ in hoặc gửi email.", "5–10 phút", pricingMarkup("digital", "Từ "))}${typeCard("handwritten", "mail", "Gửi thư bạn viết tay", "Bạn viết sẵn trên giấy. PostDrop sẽ cử người đến nhận để lưu giữ bản gốc.", "Hẹn nhận tận nơi", pricingMarkup("physical", "Từ "))}</div>${builderActions(step)}</div>`;
  if (step === 5)
    return `<div class="workspace"><section class="panel"><h2>Thông tin người nhận</h2><div class="field"><label>Gửi lá thư này cho</label><div class="segmented">${segment("recipientMode", "self", "Chính tôi")}${segment("recipientMode", "other", "Người khác")}</div></div><div class="field-row">${field("recipientName", "Họ tên người nhận", draft.recipientName, "Nguyễn Minh Anh")}${field("recipientEmail", "Email", draft.recipientEmail, "minhanh@example.com", "email")}</div><div class="field-row">${field("recipientPhone", "Số điện thoại", draft.recipientPhone, "0901 234 567", "tel")}${field("deliveryDate", "Ngày dự kiến giao", draft.deliveryDate, "", "date")}</div><div id="date-message" class="date-message" ${isFutureDate(draft.deliveryDate) ? "" : "hidden"}>${dateMessage()}</div><div class="field"><label>Hình thức nhận</label><div class="segmented">${segment("deliveryMethod", "email", "Email")}${segment("deliveryMethod", "physical", "Thư vật lý")}</div></div>${physicalDeliveryFields()}</section><aside class="panel"><h2>Ngày gặp lại</h2><p class="panel-intro">Ngày bạn chọn sẽ trở thành một cột mốc. PostDrop sẽ đồng hành để lá thư không bị lạc đường.</p><div class="mini-envelope" style="width:100%;height:185px;aspect-ratio:auto"><span id="delivery-date-preview">${isFutureDate(draft.deliveryDate) ? formatDate(draft.deliveryDate) : "Chưa chọn ngày hợp lệ"}</span></div><div class="info-note" style="margin-top:24px">${icon("info")}<span>PostDrop sẽ gửi yêu cầu xác nhận địa chỉ trước ngày giao 30 ngày.</span></div></aside></div>${builderActions(step)}`;
  const product = pricingProduct();
  return `<div class="workspace"><section class="panel"><h2>Tóm tắt lá thư</h2><div class="envelope-preview" style="height:190px"><div class="mini-envelope" style="background:${envelopeColor()}"><span>${escapeHtml(draft.title || "Lá thư của tôi")}</span></div></div><div class="summary-list">${summaryRow("Tiêu đề", draft.title || "Chưa đặt tên")}${summaryRow("Người nhận", draft.recipientName || "Chưa điền")}${summaryRow("Ngày gửi", draft.deliveryDate ? formatDate(draft.deliveryDate) : "Chưa chọn")}${summaryRow("Video nhắn gửi", draft.videoDataUrl ? "Đã đính kèm video" : "Không có")}${summaryRow("Hình thức", deliveryLabel())}${summaryRow("Mẫu phong bì", labelize(draft.envelope))}</div><div class="sealed-message">${icon("seal")} <strong>Nội dung sắp được niêm phong.</strong><br/>Bạn sẽ gặp lại những dòng chữ này vào đúng ngày đã chọn.</div></section><aside class="panel"><h2>Chi tiết thanh toán</h2><p class="panel-intro">Thanh toán một lần cho toàn bộ hành trình.</p><div class="summary-list"><div class="summary-row"><span>Phí dịch vụ</span><strong>${pricingMarkup(product)}</strong></div><div class="summary-row total-row"><span>Tổng thanh toán</span><strong>${pricingMarkup(product)}</strong></div></div><label class="seal-check"><input id="seal-confirm" type="checkbox"/><span>Tôi hiểu rằng sau khi niêm phong, nội dung lá thư sẽ không thể chỉnh sửa.</span></label><div class="field-error" data-error="seal"></div>${builderActions(step, true)}</aside></div>`;
}

function typeCard(type, iconName, title, description, time, price) {
  const selected = draft.letterType === type;
  return `<button class="choice-card ${selected ? "selected" : ""}" data-type="${type}" aria-pressed="${selected}"><span class="choice-check">${selected ? "✓" : ""}</span><div class="choice-visual">${icon(iconName)}</div><h3>${title}</h3><p>${description}</p><div class="service-meta"><span>${time}</span><span>${price}</span></div></button>`;
}
function field(key, label, value, placeholder, type = "text") {
  const invalidDeliveryDate =
    key === "deliveryDate" && Boolean(value) && !isFutureDate(value);
  return `<div class="field"><label for="${key}">${label}</label><input id="${key}" type="${type}" data-draft="${key}" class="${invalidDeliveryDate ? "invalid" : ""}" value="${escapeHtml(value)}" placeholder="${escapeHtml(placeholder)}" ${type === "date" ? `min="${tomorrowDate()}"` : ""}/><div class="field-error" data-error="${key}">${invalidDeliveryDate ? "Ngày nhận cần nằm trong tương lai." : ""}</div></div>`;
}
function physicalDeliveryFields() {
  if (draft.deliveryMethod === "email") return "";
  return `<div class="field" id="address-field"><label for="address">Địa chỉ nhận</label><input id="address" data-draft="address" value="${escapeHtml(draft.address)}" placeholder="Số nhà, tên đường, quận/huyện, tỉnh/thành"/><div class="field-error" data-error="address"></div></div><div class="field"><label for="note">Ghi chú giao hàng <span style="font-weight:400;color:var(--muted)">(không bắt buộc)</span></label><textarea id="note" data-draft="note" style="min-height:95px" placeholder="Ví dụ: Gọi trước khi giao">${escapeHtml(draft.note)}</textarea></div>`;
}
...
function segment(group, value, label) {
  return `<button class="segment ${draft[group] === value ? "selected" : ""}" data-option="${group}" data-value="${value}" type="button">${label}</button>`;
}
function letterPreview() {
  const selectedTheme = themeOptions.some((theme) => theme.id === draft.theme)
    ? draft.theme
    : "none";
  const hasTheme = selectedTheme !== "none";
  const themeDecorations = (themeDecorationPresets[selectedTheme] || [])
    .map(
      (decoration) =>
        `<img class="theme-decoration" src="${getStickerSrc(decoration.type)}" alt="" aria-hidden="true" style="--theme-x: ${decoration.x}%; --theme-y: ${decoration.y}%; --theme-width: ${decoration.width}%; --theme-rotation: ${decoration.rotation}deg;" />`
    )
    .join("");
  const content = (
    draft.content ||
    "Những dòng chữ của bạn sẽ xuất hiện ở đây, như một lời nhắn đang chờ thời gian mang đi…"
  ).normalize("NFC");
  const decos = (draft.decorations || [])
    .map((deco) => {
...
function deliveryLabel() {
  return {
    email: "Email",
    physical: "Thư vật lý",
    hybrid: "Email và thư vật lý"
  }[draft.deliveryMethod];
}
function envelopeColor() {
  return (
    {
      burgundy: "#7a263a",
      olive: "#68705b",
...
function dateMessage() {
  if (!isFutureDate(draft.deliveryDate)) return "";
  const days = Math.ceil(
    (new Date(`${draft.deliveryDate}T00:00:00`) - new Date()) / 86400000
  );
  return `Lá thư này sẽ được gửi sau ${new Intl.NumberFormat("vi-VN").format(days)} ngày.`;
}
function validateDeliveryDate(value, { required = false } = {}) {
  const valid = isFutureDate(value);
  const control = document.querySelector('[data-draft="deliveryDate"]');
  const error = document.querySelector('[data-error="deliveryDate"]');
  control?.classList.toggle("invalid", !valid && (required || Boolean(value)));
  if (error)
    error.textContent =
      !value && required
        ? "Vui lòng chọn ngày nhận."
        : !valid && value
          ? "Ngày nhận cần nằm trong tương lai."
          : "";
  return valid;
}
function builderActions(step, checkout = false) {
  return `<div class="builder-actions">${step > 1 ? '<button type="button" class="text-button" data-save-later>Lưu và hoàn thành sau</button>' : "<span></span>"}<div class="builder-actions-group">${step > 1 ? `<button type="button" class="button button-secondary" data-back>${icon("arrowLeft")}Quay lại</button>` : ""}${step === 4 ? `<button type="button" class="button button-secondary" data-skip-video>Bỏ qua bước này</button>` : ""}<button type="button" class="button button-primary" data-next>${checkout ? "Thanh toán và niêm phong" : "Tiếp tục"}${icon(checkout ? "seal" : "arrowRight")}</button></div></div>`;
}
...
function bindVideoStep() {
  ...
  async function startCamera() {
    ...
    try {
      try {
        ...
        console.warn(
          "Could not acquire audio + video stream, falling back to video only:",
          audioErr
        );
        cameraStream = await navigator.mediaDevices.getUserMedia({
          video: true,
  ...
  btnStart?.addEventListener("click", () => {
    if (!cameraStream) {
      toast(
        "Không tìm thấy camera. Bạn có thể tải tệp video lên bên dưới.",
        "error"
      );
      return;
    }
...
function bindBuilder(step) {
  document.querySelectorAll("[data-type]").forEach(
    (card) =>
      (card.onclick = () => {
        draft.letterType = card.dataset.type;
        if (draft.letterType === "handwritten")
          draft.deliveryMethod = "physical";
        persistDraft();
        if (
          draft.letterType === "handwritten" &&
          !requireLoginForHandwritten(location.hash.slice(1))
        )
          return;
        renderBuilder(step);
      })
  ...
  document.querySelectorAll("[data-draft]").forEach((control) =>
    control.addEventListener("input", () => {
      draft[control.dataset.draft] = control.value;
      control.classList.remove("invalid");
      document
        .querySelector(`[data-error="${control.dataset.draft}"]`)
        ?.replaceChildren();
      ...
      if (control.id === "deliveryDate") {
        const validDate = validateDeliveryDate(control.value);
        const message = document.querySelector("#date-message");
        if (message) {
          message.textContent = dateMessage();
          message.hidden = !validDate;
        }
        const preview = document.querySelector("#delivery-date-preview");
        if (preview)
          preview.textContent = validDate
            ? formatDate(control.value)
            : "Chưa chọn ngày hợp lệ";
      }
      persistDraft();
    })
  );
  function applyPaperColor(paperValue) {
    ...
    const targets = document.querySelectorAll(
      ".letter-canvas-scale-layer, .letter-canvas-viewport, .letter-editor-stage, #letter-editor-root, .konvajs-content"
    );
    targets.forEach((el) => {
      ...
      (control.onclick = async () => {
        ...
        if (step === 3) {
          ...
          if (group === "paper") {
            ...
            window.dispatchEvent(
              new CustomEvent("postdrop-paper-change", {
                detail: { paper: control.dataset.value }
              })
            );
          }
          return;
        }
        if (group === "recipientMode" && control.dataset.value === "self") {
          await prefillSelfRecipient({ overwrite: true });
        }
        renderBuilder(step);
      })
  );
  ...
  document
    ...
    ?.addEventListener("click", () => nextStep(step));
  document.querySelector("[data-save-later]")?.addEventListener("click", () => {
    flushPersistDraft();
    toast(
      "Bản nháp đã được lưu. Bạn có thể quay lại bất cứ lúc nào.",
      "success"
    );
  ...
  document
    ...
    ?.addEventListener("click", () =>
      toast("Ảnh sẽ được tối ưu và đính kèm vào lá thư (bản prototype).")
    );

  if (step === 5) {
    void prefillSelfRecipient();
  }
  ...
  if (step === 3) {
    ...
    function bindStickerEvents() {
      document
        .querySelectorAll(".sticker-categories .cat-tab")
        .forEach((tab) => {
          tab.onclick = () => {
      ...
      document
        .querySelectorAll(".decorations-library .sticker-item")
        .forEach((item) => {
      ...
      previewPanel.addEventListener("click", (e) => {
        ...
        if (scaleBtn) {
          ...
          if (deco) {
            ...
            deco.scale = roundedDecorationScale(
              (deco.scale || 1) + direction * DECORATION_SCALE_STEP
            );
        ...
        if (removeBtn) {
          ...
          draft.decorations = (draft.decorations || []).filter(
            (d) => d.id !== id
          );
        ...
        if (decoration) {
          ...
          previewPanel
            .querySelectorAll(".placed-decoration")
            .forEach((item) => {
...
function bindPlacedDecorationsDrag() {
  document
    .querySelectorAll(".letter-preview .placed-decoration")
    .forEach((decoEl) => {
      decoEl.addEventListener("pointerdown", (e) => {
        if (
          e.target.closest(".sticker-controls, .resize-handle, .rotate-handle")
        )
          return;
      ...
      decoEl.addEventListener("keydown", (e) => {
        ...
        if (e.key === "+" || e.key === "=") {
          e.preventDefault();
          deco.scale = roundedDecorationScale(
            (deco.scale || 1) + DECORATION_SCALE_STEP
          );
          ...
          deco.rotation = normalizeDecorationRotation(
            (deco.rotation || 0) + direction * DECORATION_ROTATION_STEP
          );
      ...
      decoEl.querySelectorAll(".resize-handle").forEach((handle) => {
        handle.addEventListener("pointerdown", (e) => {
          ...
          const startSize =
            DECORATION_BASE_SIZE * roundedDecorationScale(deco.scale || 1);
          const startCenterX =
            previewRect.left + ((deco.x || 0) / 100) * previewRect.width;
          const startCenterY =
            previewRect.top + ((deco.y || 0) / 100) * previewRect.height;
          const corner = handle.dataset.resizeCorner;
          const cornerX = corner.includes("w") ? -1 : 1;
          const cornerY = corner.includes("n") ? -1 : 1;
          const rotationRadians =
            (normalizeDecorationRotation(deco.rotation || 0) * Math.PI) / 180;
          ...
          const onPointerMove = (moveEvt) => {
            ...
            const requestedSize =
              (vectorX * diagonalX + vectorY * diagonalY) / 2;
            ...
            const rotatedExtent =
              halfSize * (Math.abs(cosine) + Math.abs(sine));
            const centerX = Math.min(
              previewRect.right - rotatedExtent,
              Math.max(previewRect.left + rotatedExtent, requestedCenterX)
            );
            const centerY = Math.min(
              previewRect.bottom - rotatedExtent,
              Math.max(previewRect.top + rotatedExtent, requestedCenterY)
            );

            deco.scale = roundedDecorationScale(newSize / DECORATION_BASE_SIZE);
            deco.x =
              Math.round(
                ((centerX - previewRect.left) / previewRect.width) * 10000
              ) / 100;
            deco.y =
              Math.round(
                ((centerY - previewRect.top) / previewRect.height) * 10000
              ) / 100;
            ...
            decoEl.querySelector(".scale-value").textContent =
              `${Math.round(deco.scale * 100)}%`;
            decoEl.setAttribute(
              "aria-label",
              `Sticker ${deco.type}, ${Math.round(deco.scale * 100)}%, xoay ${normalizeDecorationRotation(deco.rotation || 0)} do`
            );
          };
      ...
      if (rotateHandle) {
        rotateHandle.addEventListener("pointerdown", (e) => {
          ...
          const onPointerMove = (moveEvt) => {
            ...
            const deltaDegrees =
              ((currentAngle - startPointerAngle) * 180) / Math.PI;
            const rawRotation = startRotation + deltaDegrees;
            const snappedRotation = moveEvt.shiftKey
              ? Math.round(rawRotation / DECORATION_ROTATION_STEP) *
                DECORATION_ROTATION_STEP
              : rawRotation;
            deco.rotation = normalizeDecorationRotation(snappedRotation);
            decoEl.style.setProperty("--deco-rotation", `${deco.rotation}deg`);
            decoEl.style.setProperty(
              "--deco-counter-rotation",
              `${-deco.rotation}deg`
            );
            decoEl.setAttribute(
              "aria-label",
              `Sticker ${deco.type}, ${Math.round((deco.scale || 1) * 100)}%, xoay ${deco.rotation} do`
            );
          };
...
function setError(key, message) {
  const control = document.querySelector(`[data-draft="${key}"]`);
...
async function nextStep(step) {
  if (step === 3) {
    ...
    if (invalidTitle || invalidContent) {
      toast(
        invalidTitle
          ? "Hãy đặt một tiêu đề gồm ít nhất 2 ký tự."
          : "Hãy viết ít nhất 10 ký tự trước khi tiếp tục.",
        "error"
      );
  ...
  if (step === 5) {
    ...
    if (draft.recipientName.trim().length < 2) {
      setError("recipientName", "Vui lòng nhập họ tên người nhận.");
      valid = false;
    }
    if (!/^\S+@\S+\.\S+$/.test(draft.recipientEmail)) {
      setError("recipientEmail", "Email chưa đúng định dạng.");
      valid = false;
    }
    if (draft.deliveryMethod !== "email" && draft.address.trim().length < 8) {
      setError("address", "Vui lòng nhập địa chỉ đầy đủ để giao thư.");
      valid = false;
    }
    if (!validateDeliveryDate(draft.deliveryDate, { required: true }))
      valid = false;
    if (!valid) {
      toast("Vẫn còn thông tin cần hoàn thiện.", "error");
      return;
    }
  }
  if (step === 6) {
    if (!document.querySelector("#seal-confirm")?.checked) {
      document.querySelector('[data-error="seal"]').textContent =
        "Bạn cần xác nhận điều này trước khi niêm phong.";
      return;
    }
    openModal({
      title: "Niêm phong lá thư?",
      message:
        "Hãy kiểm tra lại mọi thông tin trước khi gửi lá thư vào hành trình lưu giữ.",
      note: "Sau khi niêm phong, nội dung lá thư sẽ không thể chỉnh sửa.",
      confirm: "Niêm phong ngay",
      cancel: "Kiểm tra lại",
      modalClass: "seal-confirmation-modal",
      iconName: "seal",
...
function getAuthToken() {
  return localStorage.getItem("postdrop_access_token") || "";
}
function setAuthToken(token) {
  if (token) localStorage.setItem("postdrop_access_token", token);
  else localStorage.removeItem("postdrop_access_token");
...
function userPresentation(user) {
  if (!user)
    return { name: "Khách PostDrop", email: "Chưa đăng nhập", initials: "KP" };
  ...
  return { name, email, initials: initials || "PD" };
}

async function loadCurrentAuthUser({ force = false } = {}) {
...
function selfRecipientFromUser(user) {
  if (!user) return null;
  const metadata = user.user_metadata || {};
  return {
    recipientName: String(metadata.full_name || metadata.name || "").trim(),
    recipientEmail: String(user.email || metadata.email || "").trim(),
...
async function prefillSelfRecipient({ overwrite = false } = {}) {
  if (draft.recipientMode !== "self" || !isLoggedIn()) return;
  const recipient = selfRecipientFromUser(await loadCurrentAuthUser());
  if (!recipient || draft.recipientMode !== "self") return;

  let changed = false;
  Object.entries(recipient).forEach(([key, value]) => {
    if (!value || (!overwrite && String(draft[key] || "").trim())) return;
    draft[key] = value;
    changed = true;
    const control = document.querySelector(`[data-draft="${key}"]`);
    if (control) {
    ...
    document.querySelector(`[data-error="${key}"]`)?.replaceChildren();
  });

  if (changed) flushPersistDraft();
}

async function hydrateAppHeaderProfile() {
  const avatars = document.querySelectorAll("[data-user-avatar]");
  if (!avatars.length || !getAuthToken()) return;
  const profile = userPresentation(await loadCurrentAuthUser());
  avatars.forEach((avatar) => {
    avatar.textContent = profile.initials;
    avatar.setAttribute("aria-label", `Tài khoản ${profile.name}`);
  });
}
const PENDING_VERIFICATION_EMAIL_KEY = "postdrop_pending_verification_email";
...
function setPendingVerificationEmail(email) {
  if (email) localStorage.setItem(PENDING_VERIFICATION_EMAIL_KEY, email);
  else localStorage.removeItem(PENDING_VERIFICATION_EMAIL_KEY);
}
function requireLoginForHandwritten(redirectHash) {
  if (isLoggedIn()) return true;
  if (redirectHash)
    localStorage.setItem("postdrop_redirect_after_login", redirectHash);
...
function consumeEmailConfirmationSession() {
  const fragment = location.hash.slice(1);
  if (!fragment.includes("access_token=")) return false;
  const params = new URLSearchParams(fragment);
  if (params.get("type") !== "signup" || !params.get("access_token"))
    return false;
  setAuthToken(params.get("access_token"));
  setPendingVerificationEmail("");
  replaceHash("/dashboard");
  return true;
}

async function renderGuestOnly(renderPage, expectedHash) {
  if (!getAuthToken()) return renderPage();
  app.innerHTML = `<main id="main-content" class="auth-page"><section class="auth-form-wrap" style="grid-column:1/-1"><div class="auth-form"><div class="skeleton"></div><p style="text-align:center;margin-top:18px">Đang kiểm tra phiên đăng nhập…</p></div></section></main>`;
  try {
    const response = await apiFetch("/api/auth/me");
    if ((location.hash.slice(1) || "/") !== expectedHash) return;
    if (response.ok) {
      replaceHash("/dashboard");
      return renderDashboard();
    }
  } catch (error) {
    console.warn("Could not validate the current session:", error);
  }
  setAuthToken(null);
  if ((location.hash.slice(1) || "/") === expectedHash) renderPage();
}
  ...
  try {
    const res = await fetch("/api/auth/register", {
      ...
      body: JSON.stringify({
        email: guestEmail,
        password: guestPass,
        fullName: fullName || "Khách PostDrop"
      })
    });
    if (res.ok) {
...
async function submitLetter() {
  ...
  if (next) {
    next.disabled = true;
    next.textContent = "Đang niêm phong…";
  }
  try {
    await ensureAuthToken(draft.recipientEmail, draft.recipientName);
    const expectedArrivalAt = draft.deliveryDate
      ? new Date(`${draft.deliveryDate}T09:00:00`).toISOString()
      : new Date(Date.now() + 86400000 * 365).toISOString();
    const deliveryMethod =
      draft.letterType === "handwritten" || draft.deliveryMethod === "physical"
        ? "physical"
        : "digital";
    const payload = {
      ...
      address:
        deliveryMethod === "physical" ? draft.address || undefined : undefined,
      expectedArrivalAt,
      deliveryMethod,
    ...
    let createdResponse = pendingLetterId
      ? await apiFetch(`/api/letters/${pendingLetterId}`, {
          method: "PATCH",
          body: JSON.stringify(payload)
        })
      : null;
    if (!createdResponse?.ok) {
      ...
      createdResponse = await apiFetch("/api/letters", {
        method: "POST",
        body: JSON.stringify(payload)
      });
    }
    ...
    if (!checkout.checkoutUrl)
      throw new Error("Checkout không trả về đường dẫn thanh toán");
    window.location.assign(checkout.checkoutUrl);
  } catch (error) {
    toast(
      error.message || "Chưa thể niêm phong lúc này. Vui lòng thử lại.",
      "error"
    );
    if (next) {
      next.disabled = false;
      next.innerHTML = `Thanh toán và niêm phong${icon("seal")}`;
    }
  }
}
...
function renderSuccess() {
  const date =
    currentLetter?.expectedArrivalAt?.slice(0, 10) ||
    currentLetter?.deliveryDate?.slice(0, 10) ||
    draft.deliveryDate;
...
const statusMap = {
  ...
  received: "PostDrop đã nhận thư",
  stored: "Đang được lưu giữ",
  address_confirmation: "Cần xác nhận địa chỉ",
...
async function renderDashboard() {
  ...
  try {
    const response = await apiFetch("/api/letters/dashboard");
    if (!response.ok) throw new Error();
    const data = await response.json();
    document.querySelector("#dashboard-content").innerHTML =
      `${statCards(data.summary)}<section class="letters-panel"><div class="panel-head"><h2>Những lá thư của bạn</h2><select aria-label="Lọc trạng thái"><option>Tất cả trạng thái</option><option>Đang lưu giữ</option><option>Sắp được gửi</option></select></div>${data.letters.length ? letterTable(data.letters) : emptyState()}</section>`;
  } catch {
    document.querySelector("#dashboard-content").innerHTML =
      `<div class="empty-state">${icon("info")}<h3>Chưa thể tải những lá thư</h3><p>Đường truyền đang gián đoạn hoặc bạn chưa đăng nhập.</p><button class="button button-primary" onclick="location.hash='/login'">Đăng nhập ngay</button></div>`;
  }
}

function statCards(summary) {
  return `<div class="stat-grid">${statCard("archive", summary.stored, "Thư đang lưu giữ")}${statCard("clock", summary.upcoming, "Sắp được gửi")}${statCard("map", summary.confirmation, "Cần xác nhận địa chỉ")}${statCard("check", summary.delivered, "Đã giao thành công")}</div>`;
}
function statCard(iconName, count, label) {
  return `<article class="stat-card">${icon(iconName)}<strong>${count}</strong><span>${label}</span></article>`;
}
function letterTable(letters) {
  return `<table class="letter-table"><thead><tr><th>Lá thư</th><th>Người nhận</th><th>Ngày giao</th><th>Hình thức</th><th>Trạng thái</th><th></th></tr></thead><tbody>${letters
    .map((letter) => {
      const st = letter.contentStatus || letter.status || "draft";
      const delDate = letter.expectedArrivalAt || letter.deliveryDate || "";
      return `<tr><td><strong>${escapeHtml(letter.title)}</strong><small>#${escapeHtml(letter.id.slice(-8).toUpperCase())}</small></td><td>${escapeHtml(letter.recipientName)}</td><td>${delDate ? formatDate(delDate.slice(0, 10)) : ""}</td><td>${{ digital: "Email", physical: "Thư vật lý", email: "Email", hybrid: "Cả hai" }[letter.deliveryMethod]}</td><td><span class="badge ${st}">${statusMap[st] || st}</span></td><td><a class="text-button" href="#/letters/${letter.id}">Xem chi tiết</a></td></tr>`;
    })
    .join("")}</tbody></table>`;
}
function emptyState() {
  return `<div class="empty-state">${icon("mail")}<h3>Bạn chưa có lá thư nào đang chờ trong tương lai.</h3><p>Hãy bắt đầu bằng một điều nhỏ bạn muốn nhắc mình nhớ.</p>${button("Viết lá thư đầu tiên", "/create/1?new=1")}</div>`;
}
...
async function renderLetterDetail(id) {
  ...
  try {
      ...
      ?.addEventListener("click", () => {
        openFormModal({
          ...
          onConfirm: async (modalEl) => {
            const address = modalEl
              .querySelector("#modal-new-address")
              .value.trim();
            if (!address) {
              toast("Vui lòng nhập địa chỉ đầy đủ.", "error");
              return false;
            }
            try {
              ...
              toast(e.message || "Cập nhật địa chỉ thất bại.", "error");
              return false;
            }
          }
        });
    ...
    document
      .querySelector("#btn-update-contact")
      ?.addEventListener("click", () => {
        openFormModal({
        ...
        `,
          confirmText: "Cập nhật",
          onConfirm: async (modalEl) => {
            const recipientName = modalEl
              .querySelector("#modal-rec-name")
              .value.trim();
            const recipientEmail = modalEl
              .querySelector("#modal-rec-email")
              .value.trim();
            const recipientPhone = modalEl
              .querySelector("#modal-rec-phone")
              .value.trim();
            if (recipientName.length < 2) {
              toast("Vui lòng nhập họ tên người nhận.", "error");
              return false;
            }
            try {
              const patchRes = await apiFetch(`/api/letters/${letter.id}`, {
    ...
    document
      .querySelector("#btn-view-invoice")
      ?.addEventListener("click", async () => {
        try {
          const paymentResponse = await apiFetch(
            `/api/payments/letter/${letter.id}`
          );
          const payment = await paymentResponse.json().catch(() => ({}));
          if (!paymentResponse.ok)
            throw new Error(payment.message || "Không thể tải hóa đơn");
          const paymentStatus =
            {
          ...
          openFormModal({
            ...
            <div class="summary-list">
              ...
              ${summaryRow("Phí dịch vụ", formatMoney(payment.amount, payment.currency))}
              ${summaryRow("Trạng thái thanh toán", escapeHtml(paymentStatus))}
            </div>
          `,
            cancelText: "",
            confirmText: "Đóng",
          ...
          toast(error.message || "Không thể tải hóa đơn.", "error");
        }
      });

    document
      .querySelector("#btn-contact-support")
      ?.addEventListener("click", () => {
        openFormModal({
    ...
    document.querySelector("#detail-content").innerHTML =
      `<div class="empty-state">${icon("info")}<h3>Không tìm thấy lá thư</h3><p>Lá thư có thể đã được chuyển hoặc đường dẫn không còn đúng.</p>${button("Về dashboard", "/dashboard")}</div>`;
  }
}
...
function timeline(letter) {
  ...
  return names
    .map(
      (name, i) =>
        `<div class="timeline-item ${i <= doneThrough ? "done" : ""}"><span class="timeline-dot"></span><strong>${name}</strong><span>${dates[i] ? formatDate(dates[i].slice(0, 10)) : "Chưa đến"}</span></div>`
    )
    .join("");
}
...
function renderAuth(mode = "login") {
  const config = {
    login: [
      ...
      "Đăng nhập để xem những lá thư đang chờ trong tương lai.",
      "Đăng nhập",
      "Chưa có tài khoản?",
      "Tạo tài khoản"
    ],
    register: [
      ...
      "Chỉ mất một phút để lưu giữ lá thư đầu tiên.",
      "Tạo tài khoản",
      "Đã có tài khoản?",
      "Đăng nhập"
    ],
  ...
  app.innerHTML = `<main id="main-content" class="auth-page"><section class="auth-art"><div><small>POSTDROP · THƯ GỬI ĐẾN TƯƠNG LAI</small><blockquote class="mea-culpa-regular">“Có những điều chỉ thời gian mới giúp ta hiểu được.”</blockquote></div></section><section class="auth-form-wrap"><form class="auth-form">${brand()}<h1>${config[0]}</h1><p>${config[1]}</p>${mode === "register" ? field("fullName", "Họ và tên", "", "Nguyễn Minh Anh") : ""}${field("authEmail", "Email", "", "ban@example.com", "email")}${mode !== "forgot" ? field("password", "Mật khẩu", "", "••••••••", "password") : ""}${mode === "login" ? '<div style="text-align:right;margin:-10px 0 14px"><a class="text-button" href="#/forgot">Quên mật khẩu?</a></div>' : ""}<button class="button button-primary auth-submit" type="submit">${config[2]}</button><p class="auth-helper">${config[3]} <a class="text-button" href="#/${mode === "register" ? "login" : mode === "forgot" ? "login" : "register"}">${config[4]}</a></p></form></section></main>`;
    ...
    try {
      if (mode === "register") {
        ...
        if (data.emailConfirmationRequired || !data.accessToken) {
          ...
          toast(
            "Tài khoản đã được tạo. Hãy xác nhận email để tiếp tục.",
            "success"
          );
        ...
        const data = await res.json();
        if (!res.ok) {
          const message = String(data.message || "Đăng nhập thất bại");
          if (/email not confirmed/i.test(message)) {
            setPendingVerificationEmail(email);
            toast("Email của bạn chưa được xác nhận.", "error");
            location.hash = "/verify";
            return;
          }
          throw new Error(message);
        }
        if (!data.accessToken) throw new Error("Phiên đăng nhập không hợp lệ");
        setAuthToken(data.accessToken);
        setPendingVerificationEmail("");
...
function renderVerify() {
  ...
  app.innerHTML = `<main id="main-content" class="auth-page"><section class="auth-art"><div><small>POSTDROP · MỘT BƯỚC NHỎ NỮA</small><blockquote>“Mỗi lá thư đều cần một địa chỉ để tìm đường đến tương lai.”</blockquote></div></section><section class="auth-form-wrap"><form class="auth-form" id="verification-form">${brand()}<div class="step-icon" style="margin:0 0 28px">${icon("mail")}</div><h1>Kiểm tra hộp thư của bạn</h1><p>Chúng tôi đã gửi liên kết xác nhận đến email của bạn. Sau khi bấm liên kết trong email, quay lại đây và nhập mật khẩu để kiểm tra.</p>${field("verificationEmail", "Email", pendingEmail, "ban@example.com", "email")}${field("verificationPassword", "Mật khẩu", "", "••••••••", "password")}<button class="button button-primary auth-submit" type="submit">Kiểm tra và tiếp tục</button><button class="button button-ghost auth-submit" type="button" id="resend-email">Gửi lại email xác nhận</button><p class="auth-helper">Dùng tài khoản khác? <a class="text-button" href="#/register" id="change-verification-account">Quay lại đăng ký</a></p></form></section></main>`;
  const form = document.querySelector("#verification-form");
  form.onsubmit = async (event) => {
    event.preventDefault();
    const email = form.querySelector("#verificationEmail").value.trim();
    const password = form.querySelector("#verificationPassword").value;
    ...
    try {
      ...
      if (!response.ok || !data.accessToken) {
        const message = String(
          data.message || "Email chưa được xác nhận hoặc mật khẩu chưa đúng"
        );
        throw new Error(
          /email not confirmed/i.test(message)
            ? "Email vẫn chưa được xác nhận. Hãy kiểm tra hộp thư rồi thử lại."
            : message
        );
      }
      setAuthToken(data.accessToken);
      setPendingVerificationEmail("");
      toast("Email đã được xác nhận. Chào mừng bạn đến PostDrop!", "success");
      location.hash = consumeRedirectAfterLogin();
    } catch (error) {
      toast(error.message || "Chưa thể kiểm tra trạng thái xác nhận.", "error");
      button.disabled = false;
      button.textContent = "Kiểm tra và tiếp tục";
    }
  };
  document.querySelector("#resend-email").onclick = async () => {
    const email = form.querySelector("#verificationEmail").value.trim();
    if (!/^\S+@\S+\.\S+$/.test(email)) {
      toast("Vui lòng nhập email hợp lệ.", "error");
      return;
    }
    const button = document.querySelector("#resend-email");
    button.disabled = true;
    ...
    try {
      ...
      setPendingVerificationEmail(email);
      toast("Email xác nhận mới đã được gửi.", "success");
    } catch (error) {
      toast(error.message || "Không thể gửi lại email xác nhận.", "error");
    } finally {
      button.disabled = false;
      button.textContent = "Gửi lại email xác nhận";
    }
  };
  document.querySelector("#change-verification-account").onclick = () =>
    setPendingVerificationEmail("");
}
...
function route() {
  ...
  if (hash === "/create/resume") {
    if (draft.letterType === "handwritten" && !requireLoginForHandwritten(hash))
      return;
    ...
    history.replaceState(
      null,
      "",
      `${location.pathname}${location.search}#/create/${resumeStep}`
    );
  ...
  if (hash.startsWith("/create/")) {
    ...
    const requestedStep =
      stepArg === "3.5" ? 4 : Math.min(6, Math.max(1, Number(stepArg) || 1));
    if (params.get("new") === "1") {
      const newLetterType =
        params.get("type") === "handwritten" ? "handwritten" : "online";
      resetDraft(newLetterType);
      history.replaceState(
        null,
        "",
        `${location.pathname}${location.search}#/create/1`
      );
      if (
        newLetterType === "handwritten" &&
        !requireLoginForHandwritten("/create/1")
      )
        return;
    ...
    if (
      ...
      history.replaceState(
        null,
        "",
        `${location.pathname}${location.search}#/create/2`
      );
  ...
  if (hash.startsWith("/letters/"))
    return renderLetterDetail(hash.split("/")[2]);
  if (hash === "/login")
    return void renderGuestOnly(() => renderAuth("login"), hash);
  if (hash === "/register")
    return void renderGuestOnly(() => renderAuth("register"), hash);
  if (hash === "/forgot")
    return void renderGuestOnly(() => renderAuth("forgot"), hash);
  if (hash === "/verify") return void renderGuestOnly(renderVerify, hash);
  if (hash === "/" && isLoggedIn()) {
    replaceHash("/dashboard");
    return renderDashboard();
  }
...
function initIntro() {
  ...
  const animatedTargets =
    ".intro-topbar, .intro-copy, .floating-note, .envelope-stage, .envelope, .envelope-flap, .wax-seal, .wax-seal i, .seal-halo, .intro-letter, .letter-kicker, .letter-greeting, .letter-line, .letter-signature, .intro-paper-plane, .mail-trail, .mail-trail path, .intro-glow";
  ...
  if (!hasSeenIntro && !reduced && window.anime) {
    ...
    anime.set(".letter-kicker, .letter-greeting, .letter-signature", {
      opacity: 0,
      translateY: 8
    });
  ...
  const startOpening = () => {
    ...
    const lift = Math.max(86, verticalTravel * 0.58);
    const control1 = { x: flightX * 0.2, y: startY - lift };
    const control2 = {
      x: flightX * 0.72,
      y: flightY - Math.max(28, lift * 0.22)
    };
    ...
    const cubicTangent = (start, first, second, end, progress) => {
      const remaining = 1 - progress;
      return (
        3 * remaining ** 2 * (first - start) +
        6 * remaining * progress * (second - first) +
        3 * progress ** 2 * (end - second)
      );
    };
    ...
    timeline
      ...
      .add(
        { targets: ".intro-copy", opacity: 0, translateY: -18, duration: 460 },
        0
      )
      ...
      .add(
        {
          ...
          duration: 260,
          begin: () => {
            status.textContent = "Đang mở niêm phong…";
          }
        },
        360
      )
      ...
      .add(
        {
          ...
          begin: () => {
            status.textContent = "Một lá thư từ quá khứ…";
          }
        },
        1040
      )
      .add(
        {
          targets: ".envelope-stage",
          duration: 1,
          begin: () => intro.classList.add("letter-released")
        },
        1740
      )
      .add(
        {
          targets: ".letter-kicker, .letter-greeting",
          opacity: [0, 1],
          translateY: [8, 0],
      ...
      .add(
        {
          targets: ".intro-letter",
          translateY: [extractionY, extractionY - 8],
          scaleX: [1, 0.72, 0.3],
          scaleY: [1, 0.32, 0.08],
          rotate: [-0.7, -7, -14],
          opacity: [1, 1, 0],
          ...
          begin: () => {
            status.textContent = "Lá thư đang tự gấp lại…";
          }
        },
        2800
      )
      ...
      .add(
        {
          ...
          update: () => {
            ...
            const direction = clamp(
              ((Math.atan2(tangentY, tangentX) * 180) / Math.PI) * 0.38,
              -16,
              9
            );
            const takeoffBlend = smoothStep(Math.min(1, progress / 0.16));
            const landingBlend =
              progress < 0.82 ? 1 : 1 - smoothStep((progress - 0.82) / 0.18);
            const wingDrift =
              Math.sin(progress * Math.PI * 4) * 1.6 * (1 - progress);
            const rotation =
              (-5 + (direction + 5) * takeoffBlend) * landingBlend + wingDrift;
            const scaleProgress = smoothStep(progress);
            const scale =
              1 +
              (landingScale - 1) * scaleProgress +
              Math.sin(Math.PI * progress) * 0.045;
            flyingPlane.style.transform = `translate3d(${x}px, ${y}px, 0) rotate(${rotation}deg) scale(${scale})`;
          },
          complete: () => {
            status.textContent =
              "Lá thư đã đến nơi. Chào mừng bạn đến PostDrop.";
            intro.classList.add("handoff");
            revealLanding();
            showLandedPlane();
          }
...
const emailConfirmationCompleted = consumeEmailConfirmationSession();
initIntro();
route();
void loadPricingCatalog();
if (emailConfirmationCompleted)
  toast("Email đã được xác nhận. Chào mừng bạn đến PostDrop!", "success");
